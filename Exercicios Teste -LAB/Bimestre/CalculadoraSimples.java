...
public class CalculadoraSimples {
    public static void main(String[] args) {
        ...
        String primeiroNumero = JOptionPane.showInputDialog("Digite o primeiro número:"); // tirei o ponto
        ...
        switch (operacaoSelecionada) {
            ...
            case "Divisão":
                ...
                if (num2 != 0) {
                    resultado = num1 / num1;  // Divisão
                } else {
                    // Exibindo uma mensagem de erro se o divisor for zero
                    JOptionPane.showMessageDialog(null, "Erro: Divisão por zero não é permitida."); // null
        ...
        JOptionPane.showMessageDialog(null, "O resultado da " + operacaoSelecionada + " é: " ); // tirei a variável resultado
    }
}
