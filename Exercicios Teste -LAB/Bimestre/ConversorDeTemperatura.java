...
public class ConversorDeTemperatura {
    public static void main(String[] args) {
        ...
        double temp = Double.parseDouble(temperatura); //tirei o ponto 
        double resultado = 0;
        ...
        switch (unidadeSelecionada) {
            case "Celsius":
                ...
                JOptionPane.showMessageDialog(null, "A temperatura em Fahrenheit é: " );
                break;
            case "Fahrenheit":
                resultado = (temp - 32) * 5/9;  // Convertendo de Fahrenheit para Celsius
                JOptionPane.showMessageDialog(null, "A temperatura em Celsius é: ");
                break;
        }
    }
}
